...
This project was designed, prototyped, and polished within **48 hours**. Our goal was to create a cohesive stealth loop using a minimalist "Noir" aesthetic and a robust Finite State Machine for AI.
...
* **Dynamic Detection:** Suspicion levels rise based on your current mask and proximity to guards. A 100% suspicion level results in an instant capture.

## Visual Direction (Noir Aesthetic)

* **Art Style:** High-contrast Pixel Art.
...
This repository follows a professional game development hierarchy:
...
---
*Developed during Global Game Jam 2026.*
